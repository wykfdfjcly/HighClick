...
using HighClick.Sessions;
using HighClick.Web.Controllers.Results;
using HighClick.Web.Models;
using HighClick.Web.Models.Account;
...
{
    public class AccountController : HighClickControllerBase
    {
